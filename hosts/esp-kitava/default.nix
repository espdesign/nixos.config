...
# sudo nixos-generate-config --dir ./hosts/esp-kitava
#
...

{
  imports = [
    ../common
    ./configuration.nix
    ./nvidia.nix # enable nvidia prop. drivers for gaming
    ./virt-manager.nix #enable virt-manager for virtual machines
  ];
}
